    ...
    return {
      ...
      sentiment: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().describe("The text to analyze sentiment for")
        }),
        execute: async ({ text }) => {
      ...
      summary: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().optional().describe("Text to summarize (max 300,000 characters)"),
          url: zod.z.string().optional().describe("PDF URL to summarize"),
          file_store_key: zod.z.string().optional().describe("File store key for uploaded file"),
          max_characters: zod.z.number().optional().describe("Maximum characters in summary")
        }),
      ...
      translate_text: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().describe("The text to translate"),
          target_language: zod.z.string().describe('Target language code (e.g., "en", "es", "fr")'),
          current_language: zod.z.string().optional().describe("Current language code (auto-detected if not provided)")
        }),
      ...
      translate_image: tool({
        ...
        parameters: zod.z.object({
          url: zod.z.string().optional().describe("URL of the image to translate"),
          file_store_key: zod.z.string().optional().describe("File store key of uploaded image"),
          target_language: zod.z.string().describe('Target language code (e.g., "en", "es", "fr")')
        }),
      ...
      embedding: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().optional().describe("Text to generate embeddings for"),
          url: zod.z.string().optional().describe("URL of content to generate embeddings for"),
          file_store_key: zod.z.string().optional().describe("File store key of uploaded content"),
          type: zod.z.enum(["text", "text-other", "image", "audio", "pdf"]).describe("Type of content"),
          token_overflow_mode: zod.z.enum(["truncate", "error"]).optional().describe("How to handle token overflow")
        }),
      ...
      prediction: tool({
        ...
        parameters: zod.z.object({
          dataset: zod.z.array(
            zod.z.object({
              value: zod.z.union([zod.z.number(), zod.z.string()]).describe("Data value"),
              date: zod.z.string().describe("Date in string format")
            })
          ).describe("Historical dataset for prediction"),
          steps: zod.z.number().describe("Number of prediction steps")
        }),
      ...
      text_to_sql: tool({
        ...
        parameters: zod.z.object({
          prompt: zod.z.string().describe("Natural language description of the SQL query needed"),
          sql_schema: zod.z.string().optional().describe("Database schema (optional)"),
          file_store_key: zod.z.string().optional().describe("File store key for schema file"),
          database: zod.z.enum(["postgresql", "mysql", "sqlite"]).optional().describe("Database type")
        }),
      ...
      ai_scrape: tool({
        ...
        parameters: zod.z.object({
          url: zod.z.string().describe("URL to scrape"),
          element_prompts: zod.z.array(zod.z.string()).describe("Prompts describing what to extract from the webpage"),
          selectors: zod.z.array(zod.z.string()).optional().describe("CSS selectors to extract"),
          root_element_selector: zod.z.string().optional().describe("Root element selector to limit scraping scope")
        }),
      ...
      html_to_any: tool({
        ...
        parameters: zod.z.object({
          html: zod.z.string().optional().describe("HTML content to convert"),
          url: zod.z.string().optional().describe("URL of webpage to convert"),
          type: zod.z.enum(["pdf", "png", "jpeg", "webp"]).optional().describe("Output format type"),
          width: zod.z.number().optional().describe("Output width"),
          height: zod.z.number().optional().describe("Output height"),
          full_page: zod.z.boolean().optional().describe("Capture full page")
        }),
      ...
      web_search: tool({
        ...
        parameters: zod.z.object({
          ...
          safe_search: zod.z.enum(["strict", "moderate", "off"]).default("moderate")
        }),
      ...
      search_suggestions: tool({
        ...
        parameters: zod.z.object({
          query: zod.z.string().describe("Query to get suggestions for")
        }),
        execute: async ({ query }) => {
      ...
      vocr: tool({
        ...
        parameters: zod.z.object({
          prompt: zod.z.union([zod.z.string(), zod.z.array(zod.z.string())]).describe("Prompt(s) for text extraction"),
          url: zod.z.string().optional().describe("URL of image to process"),
          file_store_key: zod.z.string().optional().describe("File store key of uploaded image"),
          page_range: zod.z.array(zod.z.number()).optional().describe("Page range for PDF files")
        }),
      ...
      object_detection: tool({
        ...
        parameters: zod.z.object({
          url: zod.z.string().optional().describe("URL of image to analyze"),
          file_store_key: zod.z.string().optional().describe("File store key of uploaded image")
        }),
      ...
      speech_to_text: tool({
        ...
        parameters: zod.z.object({
          url: zod.z.string().optional().describe("URL of audio file"),
          file_store_key: zod.z.string().optional().describe("File store key of uploaded audio"),
          language: zod.z.string().optional().describe("Language code for transcription"),
          translate: zod.z.boolean().optional().describe("Translate to English"),
          by_speaker: zod.z.boolean().optional().describe("Separate by speaker")
        }),
      ...
      nsfw_detection: tool({
        ...
        parameters: zod.z.object({
          url: zod.z.string().optional().describe("URL of image to check"),
          file_store_key: zod.z.string().optional().describe("File store key of uploaded image")
        }),
        execute: async ({ url, file_store_key }) => {
      ...
      profanity_check: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().describe("Text to check for profanity"),
          censor_replacement: zod.z.string().optional().default("*").describe("Character to replace profanity with")
        }),
      ...
      spell_check: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().describe("Text to spell check"),
          language_code: zod.z.string().optional().default("en").describe("Language code for spell checking")
        }),
      ...
      spam_check: tool({
        ...
        parameters: zod.z.object({
          text: zod.z.string().describe("Text to check for spam")
        }),
        execute: async ({ text }) => {
...
exports.JigsawStackToolSet = JigsawStackToolSet;
